...
stdbuf -o0 python run_pipeline.py --path workload/$workload --name $name --window-size $window --n_clusters $clusters --iptype sqrt --threshold $thres --line_gap $gap --line_length $length --blocksize $blocksize --filter_percent $fp > logs/$log
